    ...
    function submitLogin(e){
        ...
        if (!emailAddress || !userPassword ) {
            ...
            if (
                ...
                props.load_login_user(emailAddress, userPassword);
            }
                                  ...
                                  <div className="panel-main-div">
                                      <div className="main-div-parent">
                                           <div className="login-form">
                                            ...
                                            <Form.Control className="password-input" type="password" placeholder="Password" value={userPassword} onChange={changePasswordFieldValue} required/>
                                            </Form.Group>
                                            ...
                                            <Button className="login-button" variant="primary" type="button" onClick={submitLogin}>
...
const mapStatesToProps = (states,props)=>{
  ...
  const mapDispatchToProps = (dispatch)=>{
    return {
        load_login_user : (email,password) => dispatch({
