                ...
                <Row className="gx-0">
                    ...
                    <Col sm={6}>
                        <div className="place-map">
                            {    
                                info?.placeLocation?._latitude + "/"+ info?.placeLocation?._longitude
                            }
                        </div>
                        ...
                        <Row xs={1} sm={2} md={4} className="g-5">
                                ...
                                <Col key={idx}>
                                    <Link to={`/customer/hotel/${_.id}`} className="text-white">
                                        ...
                                        <Card.Title className="location-card-title"> {_.hotel_name}</Card.Title>
                                        </Card.Body>
                                    ...
                                    <Row className="gx-0">
                                        ...
                                        <Form.Group className="mb-3" controlId="formBasicArea">
                                            <Form.Label className="area-text">Area</Form.Label>
                                                                <Form.Control type="text" className="area-input" placeholder="" value={ subArea } onChange={ changeTheSubArea}/>
                                        ...
                                        <Form.Group className="mb-3" controlId="formBasicPrice">
                                            ...
                                            <div className="price-badge-div">
                                                ...
                                                <Badge className="price-badge">{budgetPrice}</Badge>
                                            </div>
                                            <div className="price-range">
                                                                    <Form.Range min='0' max='30000' value={budgetPrice} onChange={changeTheBudgetPrice }/>
                                            </div>
                                            </Form.Group>
                                            ...
                                            <Form.Label className="roomandbeds-text">Rooms and Beds</Form.Label>
                                                <Row className="gx-0">
                                                    <Col sm={12} className="roomandbeds-column">
                                                        ...
                                                        <div className='roomandbeds-column-text'>
                                                            ...
                                                            <InputGroup className="input-group-rooms">
                                                                <Button variant="" id="button-addon1" onClick={()=>changeTheRequiredRooms('decrease')}>
                                                                ...
                                                                aria-describedby="basic-addon1 basic-addon2"
                                                                                >{ requiredRooms }</Form.Label>
                                                                <Button variant="" id="button-addon2" onClick={()=>changeTheRequiredRooms('increase')}>
                                                    ...
                                                    <Col sm={12} className="roomandbeds-column">
                                                        ...
                                                        <div className='roomandbeds-column-text'>
                                                           <InputGroup className="input-group-rooms">
                                                                <Button variant="" id="button-addon1" onClick={()=>changeTheRequiredBeds('decrease')}>
                                                                <span className='minus-sign'>&darr;</span>
                                                                </Button>
                                                                <Form.Label className="rooms-label-text"
                                                                aria-label="Example text with button addon"
                                                                aria-describedby="basic-addon1 basic-addon2"
                                                                                >{ requiredBeds}</Form.Label>
                                                                <Button variant="" id="button-addon2" onClick={()=>changeTheRequiredBeds('increase')}>
                                                                <span className='plus-sign'>&uarr;</span>
                                                                </Button>
                                                            </InputGroup>
                                                            </div>
                                                    ...
                                                    <Col sm={12} className="roomandbeds-column">
                                                        ...
                                                        <div className='roomandbeds-column-text'>
                                                            <InputGroup className="input-group-rooms">
                                                                <Button variant="" id="button-addon1" onClick={()=>changeTheRequiredBaths('increase')}>
                                                                <span className='minus-sign'>&darr;</span>
                                                                </Button>
                                                                <Form.Label className="rooms-label-text"
                                                                aria-label="Example text with button addon"
                                                                aria-describedby="basic-addon1 basic-addon2"
                                                                                >{ requiredBaths}</Form.Label>
                                                                <Button variant="" id="button-addon2" onClick={()=>changeTheRequiredBaths('increase')}>
                                                                <span className='plus-sign'>&uarr;</span>
                                                                </Button>
                                                            </InputGroup>
                                                            </div>
